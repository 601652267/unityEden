Shader "SkillRestore/Particle AlphaBlend"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex; float4 _MainTex_ST; fixed4 _TintColor; fixed4 _Color;
            ...
            fixed4 frag (v2f i) : SV_Target { return 2.0 * i.color * _TintColor * _Color * tex2D(_MainTex, i.uv); }
            ENDCG
        }
    }
}
